  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          isActive
            ? "ring-2 ring-gray-950 ring-offset-2 ring-offset-[#f7f7f5]"
            : ""
        }
      `}
    >
      ...
      <div
        className={`
          ...
          ${
            isActive
              ? "bg-[#e9e8e3]"
              : "bg-white group-hover:bg-[#eeede9]"
          }
        `}
      />
      ...
      {/* <div className="absolute left-4 top-4 z-20">
        <span className="text-[9px] font-semibold tracking-[0.2em] text-gray-400">
